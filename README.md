...
**Dagger** I added dagger hilt to the project. There wasn't a ton to inject but it cleans up some things and just generally makes things easier. <br>
...
**ktlint** I did many general passes to improve and clean up code. I also added ktlint to make sure everything was formatted correctly. <br><br>
There's a bunch more little things I did to improve readability, scalability, and reliability. I'm sure I could keep improving it further, but I'm really happy with the feedback provided and the updates made.
